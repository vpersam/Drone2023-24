/*
   Calibrar ESC (solo hay que hacerlo la primera vez que se utiliza un ESC)
   Más información en https://arduproject.es/motores-esc-y-su-programacion-en-arduino/
*/

// !!!!!!!!!!!!!! RETIRAR LAS HELICES - SIN HELICES !!!!!!!!!!!!!!!!!!!!!!!!!!
// Puede que este procedimiento no sirva para todos los ESC/motores, consultad vuestra hoja de datos:
// 1) Sin conectar la batería, alimentar la placa Arduino con cable USB y cargar este programa.
// 2) Ejecutar el programa sin conectar la batería.
// 3) Cuando se encienda el led 13, encender el mando y subir el throttle al máximo.
// 4) Conectar la batería cuando se apague el LED 13.
// 5) El motor emitira unos pitidos (pi,pi), bajar el throttle al minimo.
// 6) Se escucharán otros pitidos, pipipi... piiii.
// 7) Terminado
